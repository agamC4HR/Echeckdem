                        ...
                        foreach (var row in rows)
                        {
                            ...
                            value?.Trim().ToLower() switch
                            {
                                ...
                                var location = new Ncmloc
                                {
                                    ...
                                    Oid = oid,
                                    Lname = row.Cell(1).GetValue<string>().Substring(0, Math.Min(100, row.Cell(1).GetValue<string>().Length)).Trim(),
                                    Lcity = row.Cell(2).GetValue<string>().Substring(0, Math.Min(30, row.Cell(2).GetValue<string>().Length)).Trim(),
                                    Lstate = stateAbbreviation.Trim(),
                                    Lregion = row.Cell(4).GetValue<string>().Substring(0, Math.Min(30, row.Cell(4).GetValue<string>().Length)).Trim(),
                                    Ltype = row.Cell(5).GetValue<string>().Substring(0, Math.Min(30, row.Cell(5).GetValue<string>().Length)).Trim(),
                                    Laddress = row.Cell(6).GetValue<string>().Substring(0, Math.Min(200, row.Cell(6).GetValue<string>().Length)).Replace("\"","").Trim(),
                                    Lcontact = row.Cell(7).GetValue<string>().Substring(0, Math.Min(100, row.Cell(7).GetValue<string>().Length)).Trim(),
                                    Lconemail = row.Cell(8).GetValue<string>().Substring(0, Math.Min(100, row.Cell(8).GetValue<string>().Length)).Trim(),
                                    Lconno = row.Cell(9).GetValue<string>().Substring(0, Math.Min(50, row.Cell(9).GetValue<string>().Length)).Trim(),
                                    Cemail = row.Cell(10).GetValue<string>().Substring(0, Math.Min(100, row.Cell(10).GetValue<string>().Length)).Trim(),
